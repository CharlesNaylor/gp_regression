...
Restating what I put at the top of the [overview notebook](https://cdn.rawgit.com/billWalker/gp_regression/edac7693/doc/Specifying_the_Model-Overview_and_Simplest_Implementation.html)
...
```
That took 5 hours on my laptop. We had 3 exogs and 2 endos. The full model has 5 exogs and 11 assets.
Now, did it work?

```{r}
stopifnot(require(bayesplot))
mcmc_trace(as.array(single_fit), pars=c("alpha[1]", "rho[2]", "L_omega[2,1]", 
